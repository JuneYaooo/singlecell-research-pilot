...
TRACE_ROWS = (
    TraceRow(
        ...
        evidence_files=(
            "analysis/course_run/logs/sessionInfo.txt",
            "analysis/workflow_run/tables/module_status.tsv",
        ),
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_core.R; analysis/course_run/objects/single_matrix_import.rds",
        ...
        evidence_files=("analysis/course_run/objects/single_matrix_import.rds",),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_core.R; multi_matrix_GSE118389.rds; multi_matrix_GSE158631.rds",
        adapted_key_calls="CreateSeuratObject(); PercentageFeatureSet()",
        ...
        acceptance_status=ACCEPTED,
        evidence_files=(
            "analysis/course_run/objects/multi_matrix_GSE118389.rds",
            "analysis/course_run/objects/multi_matrix_GSE158631.rds",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_core.R; standard10x_tar_import_list.rds",
        ...
        equivalence_level=COURSE_CONSISTENT,
        acceptance_status=ACCEPTED,
        evidence_files=("analysis/course_run/objects/standard10x_tar_import_list.rds",),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_core.R; nonstandard10x_first_import.rds",
        ...
        equivalence_level=COURSE_CONSISTENT,
        acceptance_status=ACCEPTED,
        evidence_files=("analysis/course_run/objects/nonstandard10x_first_import.rds",),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_core.R; multi10x_merged_raw.rds",
        ...
        equivalence_level=COURSE_CONSISTENT,
        acceptance_status=ACCEPTED,
        evidence_files=("analysis/course_run/objects/multi10x_merged_raw.rds",),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_core.R; h5_first_import.rds",
        ...
        equivalence_level=COURSE_CONSISTENT,
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=("analysis/course_run/objects/h5_first_import.rds",),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_core.R; qc_cell_counts.tsv; QC figures",
        ...
        acceptance_status=ACCEPTED,
        evidence_files=(
            "analysis/course_run/tables/qc_cell_counts.tsv",
            "analysis/course_run/figures/01_QC_before_violin.png",
            "analysis/course_run/figures/02_QC_after_violin.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_core.R; processed_multi10x_qc_harmony_cluster.rds",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/course_run/objects/processed_multi10x_qc_harmony_cluster.rds",
            "analysis/course_run/figures/03_variable_features.png",
            "analysis/course_run/figures/04_elbow_plot.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_scrublet.py; scrublet_doublet_scores.tsv; cell_counts_before_after_doublet.tsv",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/workflow_run/tables/scrublet_doublet_scores.tsv",
            "analysis/workflow_run/tables/cell_counts_before_after_doublet.tsv",
            "analysis/workflow_run/figures/umap_doublet_class.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_reprocess_singlets.R; annotated_consensus.rds",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/workflow_run/objects/rds/annotated_consensus.rds",
            "analysis/workflow_run/tables/singlet_reprocess_summary.tsv",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_core.R; processed object and UMAP figures",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/course_run/figures/05_umap_clusters.png",
            "analysis/course_run/figures/06_umap_sample_id.png",
            "analysis/course_run/figures/07_umap_condition.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_reprocess_singlets.R; consensus_annotation.tsv; marker_rule_scores.tsv",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/workflow_run/tables/consensus_annotation.tsv",
            "analysis/workflow_run/tables/marker_rule_scores.tsv",
            "analysis/workflow_run/figures/marker_dotplot_consensus.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_subset.R; subset_T_cells.rds; subset_T_cells_barcodes.tsv",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/workflow_run/objects/rds/subset_T_cells.rds",
            "analysis/workflow_run/tables/subset_T_cells_barcodes.tsv",
            "analysis/workflow_run/tables/subset_T_cells_summary.tsv",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_gene_expression_plotting.R; gene_expression_* tables and figures",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/workflow_run/tables/gene_expression_requested_genes.tsv",
            "analysis/workflow_run/tables/gene_expression_summary.tsv",
            "analysis/workflow_run/figures/gene_expression_featureplot.png",
            "analysis/workflow_run/figures/gene_expression_dotplot.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_celltypist_bounded.py; celltypist_bounded_annotation.tsv; consensus_annotation.tsv",
        ...
        evidence_files=(
            "analysis/workflow_run/tables/celltypist_bounded_annotation.tsv",
            "analysis/workflow_run/tables/consensus_annotation.tsv",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        acceptance_status=SKIPPED,
        evidence_files=("analysis/workflow_run/tables/consensus_annotation.tsv",),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_reprocess_singlets.R; cluster_markers_seurat.tsv",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/workflow_run/tables/cluster_markers_seurat.tsv",
            "analysis/workflow_run/tables/cluster_markers_top5_seurat.tsv",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_findmarkers.R; findmarkers_pairwise.tsv; findmarkers_pairwise_volcano.png",
        ...
        acceptance_status=ACCEPTED,
        evidence_files=(
            "analysis/workflow_run/tables/findmarkers_pairwise.tsv",
            "analysis/workflow_run/tables/findmarkers_pairwise_params.tsv",
            "analysis/workflow_run/figures/findmarkers_pairwise_volcano.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_enrichment.py; enrichment_gprofiler.tsv",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/workflow_run/tables/enrichment_gprofiler.tsv",
            "analysis/workflow_run/tables/enrichment_method_status.tsv",
            "analysis/workflow_run/figures/enrichment_dotplot.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_trajectory.py; trajectory_pseudotime.tsv",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/workflow_run/tables/trajectory_pseudotime.tsv",
            "analysis/workflow_run/figures/trajectory_pseudotime_umap.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_communication.py; communication_lr_scores.tsv",
        ...
        evidence_files=(
            "analysis/workflow_run/tables/communication_lr_scores.tsv",
            "analysis/workflow_run/figures/communication_lr_heatmap.png",
        ),
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_cnv_proxy.py; cnv_proxy_scores.tsv",
        ...
        acceptance_status=NOT_ACCEPTED_FOR_EQUIVALENCE,
        evidence_files=(
            "analysis/workflow_run/tables/cnv_proxy_scores.tsv",
            "analysis/workflow_run/figures/cnv_proxy_umap.png",
        ),
        python_only_feasibility="PYTHON_PROXY_ONLY",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_module_coexpression.py; coexpression_gene_modules.tsv; coexpression_module_scores.tsv",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/workflow_run/tables/coexpression_gene_modules.tsv",
            "analysis/workflow_run/tables/coexpression_module_scores.tsv",
            "analysis/workflow_run/tables/coexpression_module_celltype_summary.tsv",
            "analysis/workflow_run/figures/coexpression_module_celltype_heatmap.png",
        ),
        python_only_feasibility="PYTHON_EQUIVALENT_AVAILABLE",
    ...
    TraceRow(
        ...
        adapted_script_or_output="scripts/run_course_cibersort.R; CIBERSORT-Results.tsv",
        ...
        acceptance_status=ACCEPTED_WITH_CAVEAT,
        evidence_files=(
            "analysis/course_run/cibersort/CIBERSORT-Results.tsv",
            "analysis/course_run/cibersort/cibersort_fraction_barplot.png",
        ),
        python_only_feasibility="PYTHON_PROXY_ONLY",
    ...
    TraceRow(
        ...
        acceptance_status=SKIPPED,
        evidence_files=("analysis/course_run/cibersort/CIBERSORT-Results.tsv",),
        python_only_feasibility="PYTHON_PROXY_ONLY",
...
def resolve_evidence_path(item: str, workflow_dir: Path) -> Path:
    default_prefix = Path("analysis/workflow_run")
    item_path = Path(item)
    try:
        relative = item_path.relative_to(default_prefix)
        return workflow_dir / relative
    except ValueError:
        return item_path
...
def file_evidence(paths: tuple[str, ...], workflow_dir: Path) -> str:
    parts = []
    for item in paths:
        path = resolve_evidence_path(item, workflow_dir)
...
def build_traceability(course_root: Path, workflow_dir: Path) -> pd.DataFrame:
    rows = []
        ...
        rows.append(
            {
                ...
                "validation_evidence": file_evidence(row.evidence_files, workflow_dir),
...
def write_report(table: pd.DataFrame, report_path: Path) -> None:
    ...
    report = f"""# Seurat Source Traceability Report

## Purpose

This report audits whether the current runnable workflow is traceable to the original Seurat course scripts. It does not claim that replacement modules are numerically identical to unavailable original packages. Proxy modules are explicitly labeled and cannot be accepted as method-equivalent outputs.
...
def main() -> None:
    ...
    out_dir = args.workflow_dir
    tables_dir = out_dir / "tables"
    tables_dir.mkdir(parents=True, exist_ok=True)

    table = build_traceability(args.course_root, args.workflow_dir)
    errors = validate_traceability(table, args.course_root, args.workflow_dir)
    if errors:
        for error in errors:
            print(f"ERROR: {error}")
        raise SystemExit(1)
